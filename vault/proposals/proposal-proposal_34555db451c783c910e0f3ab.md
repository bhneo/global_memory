...
action: "create"
target_id: "claim_wechat_embodied_data_four_layers_20260716"
target_path: "vault/knowledge/claims/claim_wechat_embodied_data_four_layers_20260716-该文将具身数据基础设施分为可视化-目录检索-标注供给与评测训练闭环四层-称最内层闭环最难外包.md"
base_path: null
base_sha256: null
candidate_path: "vault/proposals/candidate-proposal_34555db451c783c910e0f3ab.md"
candidate_sha256: "b3392b59e933c95f5a88e59184272e1a28c60de3a8882dc55ed831aea0363149"
...
- 提议理由：导入 claim_wechat_embodied_data_four_layers_20260716
...
```diff
--- /dev/null
+++ candidate:vault/knowledge/claims/claim_wechat_embodied_data_four_layers_20260716-该文将具身数据基础设施分为可视化-目录检索-标注供给与评测训练闭环四层-称最内层闭环最难外包.md
@@ -0,0 +1,24 @@
+---
