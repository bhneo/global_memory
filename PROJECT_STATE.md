...
> M7 consolidation governance (2026-07-17): validated compile output now enters `vault/memory/` as Working; type-specific, explainable policy may promote it to Trusted during Weekly consolidation. Exceptions and Canonical promotion cards isolate the small human-review surface. Only explicit `gm promotion approve` writes Canonical. Context Pack and Obsidian expose tiers, and legacy pending proposals have a dry-run/backed-up/idempotent migration path. Real-corpus migration and final acceptance counts are recorded after the validation run below.

> M7 real-corpus acceptance (2026-07-17): 21 legacy pending proposals plus the remaining capture-only sources were consolidated into 113 memory objects: 83 Working and 30 Trusted. Proposal state is now 38 migrated, 143 superseded, 4 approved, 0 pending/deferred; inbox is empty. Weekly reduced current human review to 2 explicit synthesis-drift exceptions (estimated 6 minutes, compression ratio 0.9623), produced no Canonical candidates, and wrote zero Canonical files. The single existing Canonical claim retained SHA-256 `54869CE8FE7C65F0E3063EE060682E171937B87429AA4A83C44E7E7F3685772E` throughout migration/daily/weekly runs. Final integrity: 145 tests, doctor 167/167, lint 659 documents, raw 53 sources/52 unique objects.
