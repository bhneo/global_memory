...
```powershell
.\scripts\galois.ps1 activation record <object-id> --kind used --project embodied-agent --reason "用于架构决策"
.\scripts\galois.ps1 activation show <object-id>
.\scripts\galois.ps1 activation top --project embodied-agent
