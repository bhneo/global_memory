...
- 后续：先把重新识别的 PhySO compound claim 拆成两个 atomic children；继续核验其余 partial-entailment claims；关闭剩余 6 个 primary follow-ups；分批批准高价值 concept/question/tension/synthesis。
